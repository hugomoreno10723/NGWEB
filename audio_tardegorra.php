  ...
  <div class="container_12">
      <div class="grid_9">
        <div class="">
         ...
         <center> <img src="images/regalo.jpg" alt="" align="center" width="520" height="364"></center><br/>
    ...
    var share = new Share("#share-button-top", {
      networks: {
        facebook: {
		  ...
		  title: "Escucha la plenaria que compartió con nosotros, Raúl Borboa: Vencidos por su amor y su gracia",
		...
		twitter: {
      url: "http://ngmexico.com/jovenes/series.html",
      text: "Escucha la plenaria que compartió con nosotros, Raúl Borboa: Vencidos por su amor y su gracia",
    },
	google_plus: {
      url: "http://ngmexico.com/jovenes/series.html",
    },
